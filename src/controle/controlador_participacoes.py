        ...
        if len(self.__participacoes) > 0:
            ...
            try:
                if participacao is not None:
                    ...
                    participacao.data_horario_saida = [horario_saida_participacao["dia_evento"],
        ...
        if len(self.__participacoes) > 0:
            ...
            try:
                if participacao is not None:
                    ...
                    participacao.data_horario_entrada = [novos_dados_participacao["dia_evento"],
                                                         novos_dados_participacao["mes_evento"],
                                                         novos_dados_participacao["ano_evento"],
        ...
        if len(self.__participacoes) > 0:
            ...
            if participacao is not None:
                self.__tela_participacao.mostrar_participacao({"id": participacao.id,
                                                               ...
                                                               "cpf_participante": participacao.cpf,
    ...
    def pegar_participacao(self, dados_participacao):
        for participacao in self.__participacoes:
            if participacao.id_evento == dados_participacao["id_evento"]\
                    and participacao.participante.cpf == dados_participacao["cpf_participante"]:
                return participacao
        return None
